/****************************************************************************
** Meta object code from reading C++ file 'hangman.h'
**
...
#error "The header file 'hangman.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject HangmanGame::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHangmanGameENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<HangmanGame, std::true_type>
    >,
    nullptr
} };
